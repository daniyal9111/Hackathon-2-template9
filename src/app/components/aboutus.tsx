...
const aboutus = () => {
  return (
    ...
    <div className="mt-[50px] md:mt-0 ">
      <Image src={a1} alt="About Us Image 1" className="" />
      <div className="flex flex-col md:flex-row mt-[16px] md:mt-[0]">
        <Image src={a2} alt="About Us Image 2" className="mr-[16px] pt-[40px]" />
        <Image src={a3} alt="About Us Image 3" className="pt-[40px]" />
      </div>
    </div>
  </section>
  )
